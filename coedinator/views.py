...
def add_event(request):
    u = CordinatorRegister.objects.get(user_id=request.user)
    if request.method == 'POST':
        ...
        form = EventForm()
    return render(request, 'coedinator/add_event.html', {'form': form})


def event_list(request):
    eve_list = Event.objects.all()
    return render(request, 'coedinator/events.html', {'events': eve_list})
...
def event_details(request, id):
    ...
    return render(request, 'coedinator/event_details.html', {'events': eve_list, 'part': participant_list, 'speaker': speaker})
...
def event_edit(request, id):
    ...
    if form.is_valid():
        ...
        print(form.errors)
    return render(request, 'coedinator/edite_event.html', {'form': form})


def event_delete(request, id):
    user2 = Event.objects.get(id=id).delete()
    return HttpResponseRedirect(reverse('coedinator:event_list'))
...
def add_speaker(request):
    if request.method == 'POST':
        ...
        form = SpeakerForm()
    return render(request, 'coedinator/add_speaker.html', {'form': form})


def visitors_list(request):
    visitors = VisitorRegister.objects.all()
    return render(request, 'coedinator/visitors_list.html', {'visitors': visitors})

def visitors_delete(request, id):
    user2 = VisitorRegister.objects.get(id=id).delete()
    return HttpResponseRedirect(reverse('coedinator:visitors_list'))
...
def edit_visitors(request, id):
    ...
    if form.is_valid() and form_p.is_valid():
        ...
        return redirect('coedinator:visitors_list')
    else:
        print(form.errors)
    return render(request, 'coedinator/edite_visitors.html', {'form': form, 'form_p': form_p})


def students_list(request):
    student = StudentRegister.objects.all()
    return render(request, 'coedinator/student_list.html', {'student': student})
...
def edit_student(request, id):
    instance2 = StudentRegister.objects.get(id=id)
    instance = User.objects.get(id=instance2.user.id)
    ...
    if form.is_valid() and form_p.is_valid():
        ...
        return redirect('university:student_list')
    else:
        print(form.errors)
    return render(request, 'coedinator/edite_students.html', {'form': form, 'form_p': form_p})

def student_delete(request, id):
    user2 = StudentRegister.objects.get(id=id).delete()
    return HttpResponseRedirect(reverse('coedinator:student_list'))
...
def post(request):
    ...
    return render(request, 'coedinator/past_evnt.html', {'postForm': postForm, 'formset': formset})


def past_events(request):
    e_list = PastEvent.objects.all()
    return render(request, 'coedinator/p_event_list.html', {'e_list': e_list})


def past_details(request, id):
    e_list = PastEvent.objects.get(id=id)
    im = Images.objects.filter(event_id=e_list.id)
    return render(request, 'coedinator/p_event_det.html', {'e_list': e_list, 'im': im})
